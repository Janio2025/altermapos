                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="nome_organizador" type="text" name="nome_organizador" value="<?php echo $result->nome_organizador; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label for="ativa" class="btn btn-default">Ativo
                                    <input type="checkbox" id="ativa" name="ativa" class="badgebox" value="1" <?= ($result->ativa == 1) ? 'checked' : '' ?>>
                ...
                <div class="form-actions">
                    <div class="span12">
                        <div class="span6 offset3" style="display:flex;justify-content: center">
                            ...
                            <a title="Voltar" class="button btn btn-warning" href="<?php echo site_url() ?>/organizadores">
