    ...
    var myChart = new Chart(ctx, {
        data: {
            ...
            datasets: [{
                    ...
                    data: [<?php echo(($financeiro_mes->VALOR_JAN_REC + $financeiro_mes->VALOR_JAN_OS) - $financeiro_mes->VALOR_JAN_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_FEV_REC + $financeiro_mes->VALOR_FEV_OS) - $financeiro_mes->VALOR_FEV_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_MAR_REC + $financeiro_mes->VALOR_MAR_OS) - $financeiro_mes->VALOR_MAR_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_ABR_REC + $financeiro_mes->VALOR_ABR_OS) - $financeiro_mes->VALOR_ABR_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_MAI_REC + $financeiro_mes->VALOR_MAI_OS) - $financeiro_mes->VALOR_MAI_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_JUN_REC + $financeiro_mes->VALOR_JUN_OS) - $financeiro_mes->VALOR_JUN_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_JUL_REC + $financeiro_mes->VALOR_JUL_OS) - $financeiro_mes->VALOR_JUL_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_AGO_REC + $financeiro_mes->VALOR_AGO_OS) - $financeiro_mes->VALOR_AGO_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_SET_REC + $financeiro_mes->VALOR_SET_OS) - $financeiro_mes->VALOR_SET_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_OUT_REC + $financeiro_mes->VALOR_OUT_OS) - $financeiro_mes->VALOR_OUT_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_NOV_REC + $financeiro_mes->VALOR_NOV_OS) - $financeiro_mes->VALOR_NOV_DES); ?>,
                        <?php echo(($financeiro_mes->VALOR_DEZ_REC + $financeiro_mes->VALOR_DEZ_OS) - $financeiro_mes->VALOR_DEZ_DES); ?>
                    ],
                ...
                {
                    label: 'Receita Bruta',
                    data: [<?php echo($financeiro_mes->VALOR_JAN_REC + $financeiro_mes->VALOR_JAN_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_FEV_REC + $financeiro_mes->VALOR_FEV_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_MAR_REC + $financeiro_mes->VALOR_MAR_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_ABR_REC + $financeiro_mes->VALOR_ABR_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_MAI_REC + $financeiro_mes->VALOR_MAI_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_JUN_REC + $financeiro_mes->VALOR_JUN_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_JUL_REC + $financeiro_mes->VALOR_JUL_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_AGO_REC + $financeiro_mes->VALOR_AGO_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_SET_REC + $financeiro_mes->VALOR_SET_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_OUT_REC + $financeiro_mes->VALOR_OUT_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_NOV_REC + $financeiro_mes->VALOR_NOV_OS); ?>,
                        <?php echo($financeiro_mes->VALOR_DEZ_REC + $financeiro_mes->VALOR_DEZ_OS); ?>
                    ],
