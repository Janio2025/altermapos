<style>
  ...
  @media (max-width: 768px) {
    table#tabela-garantias thead {
      display: none;
    }

    table#tabela-garantias tbody tr {
      display: block;
      margin-bottom: 15px;
    ...
    table#tabela-garantias tbody tr td {
      display: flex;
    ...
    table#tabela-garantias tbody tr td::before {
    ...
    table#tabela-garantias tbody tr td:last-child {
      display: flex;
...
<div class="new122">
  ...
  <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aGarantia')) { ?>
    <a href="<?php echo base_url(); ?>index.php/garantias/adicionar" class="button btn btn-mini btn-success" style="max-width: 160px">
      <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">Termo Garantia</span>
    </a>
  <?php } ?>

  <div class="widget-box">
    <div class="widget-content nopadding tab-content">
      <table id="tabela-garantias" class="table table-bordered">
        <thead>
          <tr>
            <th>#</th>
            <th>Data</th>
        ...
        <tbody>
          ...
          foreach ($results as $r) {
            ...
            echo '<tr>';
            echo '<td data-label="#">' . $r->idGarantias . '</td>';
            echo '<td data-label="Data">' . $dataGarantia . '</td>';
            echo '<td data-label="Ref. Garantia">' . $r->refGarantia . '</td>';
            echo '<td data-label="Termo de Garantia">' . $textoGarantiaShort . '</td>';
            echo '<td data-label="Usuario"><a href="' . base_url() . 'index.php/usuarios/editar/' . $r->idUsuarios . '">' . $r->nome . '</a></td>';
