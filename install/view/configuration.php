<form name="config-form" id="config-form" action="do_install.php" method="post">
  ...
  <div class="section clearfix">
    ...
    <div>
      ...
      <div class="form-group clearfix">
        <label for="full_rg" class=" col-md-3">|RG*</label>
        <div class="col-md-9">
          <input type="text" value="" id="full_rg" name="full_rg" class="form-control" placeholder="RG" />
        </div>
      </div>
      <div class="form-group clearfix">
        <label for="full_cpf" class=" col-md-3">CPF*</label>
        <div class="col-md-9">
          <input type="text" value="" id="cpfUser" id="full_cpf" name="full_cpf" class="form-control" placeholder="CPF" />
        </div>
      </div>
      <div class="form-group clearfix">
